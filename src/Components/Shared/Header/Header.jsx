const Header = () => {
    ...
    const stats = [
      { name: "Published Articles", value: "200+" },
      { name: "Active Writers", value: "15" },
      { name: "Monthly Visitors", value: "50,000+" },
      { name: "Years Online", value: "5" },
    ];
    return (
      <>
        <div className="relative isolate overflow-hidden bg-white dark:bg-gray-800 py-24 sm:py-32 mx-auto max-w-7xl rounded-lg drop-shadow-2xl">
          <div
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700 dark:text-gray-300">
               Your go-to destination for insightful articles on various topics. Dive into our collection of thought-provoking content curated just for you.
              </p>
            </div>
